...
CONF_POT_INF, CONF_POT_SUP, ESTADO_ALARME_POT, POT_Desliga, POT_Liga, Freq_Alarme,
LED_FINALIZADO, FREQ_FINALIZADO, FREQUENCIA_ATUALIZACAO, CONFI_LED, DATA_FINALIZADO, POT_FINALIZADO, LDR_FINALIZADO}Estados_enum;
